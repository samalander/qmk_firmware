...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_GAMING] = LAYOUT(
    ...
    KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,     KC_SPC,                       KC_UP,   KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LCTL,   KC_LCTL, KC_LALT, KC_LALT,          KC_ESC,   KC_SPC, KC_ENT,     KC_LEFT,  KC_DOWN, KC_RGHT,          KC_BSPC, KC_RALT, KC_RCTL, KC_RCTL
  ),
