...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT(
    KC_ESC,    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,     XXXXXXX,                        XXXXXXX, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    CW_TOGG,
    ...
    XXXXXXX,   XXXXXXX, XXXXXXX, XXXXXXX,          LS_MEDIA, LS_NAV,  LS_MOUSE,      LS_SYM, LS_NUM,  LS_FUN,           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_NAV] = LAYOUT(
    ...
    XXXXXXX, KC_LGUI, KC_LALT, KC_LCTL, KC_LSFT, XXXXXXX, XXXXXXX,                        XXXXXXX, KC_CAPS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, XXXXXXX,
    XXXXXXX, XXXXXXX, KC_RALT, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,                        XXXXXXX, KC_INS,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,  XXXXXXX,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, _______, XXXXXXX,      KC_ENT,  KC_BSPC, KC_DEL,           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_MOUSE] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, _______,      KC_BTN2, KC_BTN1, KC_BTN3,           XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_MEDIA] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          _______, XXXXXXX, XXXXXXX,      KC_MSTP, KC_MPLY, KC_MUTE,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_NUM] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_DOT,  KC_0,    KC_MINS,      XXXXXXX, _______, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_SYM] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_LPRN, KC_RPRN, KC_UNDS,      _______, XXXXXXX, XXXXXXX,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_FUN] = LAYOUT(
    ...
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,          KC_APP,  KC_SPC,  KC_TAB,       XXXXXXX, XXXXXXX, _______,          XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX
  ),
  ...
  [_GAMING] = LAYOUT(
    ...
    KC_LSFT,   KC_Z,    KC_X,    KC_C,    KC_D,    KC_V,     KC_UP,                        KC_SPC,  KC_K,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT,
    KC_LCTL,   KC_LCTL, KC_LALT, KC_LALT,          KC_LEFT,  KC_DOWN, KC_RGHT,     KC_ESC, KC_ENT,  KC_ENT,           KC_BSPC, KC_RALT, KC_RCTL, KC_RCTL
  ),
